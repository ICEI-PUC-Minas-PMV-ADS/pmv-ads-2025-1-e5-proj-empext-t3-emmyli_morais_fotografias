  ...
  return (
    <div className="font-serif bg-[#0B3727] min-h-screen text-[#c09b2d] flex flex-col">
      ...
      <div className="w-full md:w-1/2">
        <form className="flex flex-col gap-4 text-sm sm:text-base">
          ...
          <button className="mt-4 bg-[#c09b2d] text-white font-bold py-2 sm:py-3 rounded-md hover:bg-[#d9a766] transition text-sm sm:text-base">
            Enviar
          </button>
        </form>
      </div>
