...
const PagamentoAprovado = () => {
  ...
  return (
    <div className="p-20 flex flex-col gap-5 items-center justify-center font-serif bg-[#F9F9F9] w-screen h-screen">
      ...
      <p className=" text-lg">
        Suas fotos escolhidas foram enviadas para a fotógrafa e ela irá te
        comunicar quando estiverem editadas.
      </p>
      <p className=" text-lg">
       As fotos escolhidas se encontram no menu <b>"Galeria"</b>.
      </p>
