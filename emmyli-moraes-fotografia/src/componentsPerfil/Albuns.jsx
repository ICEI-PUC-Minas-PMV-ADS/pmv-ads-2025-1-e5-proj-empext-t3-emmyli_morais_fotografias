        ...
        <>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-lg max-w-sm w-full lg:min-h-[80vh]">
              ...
              <p className="text-[#c09b2d] text-xl font-bold text-center mb-2">
                {console.log("albumAberto", albumAberto)}
                Cliente: {albumAberto.usuario}
              </p>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4">
                {fotosVisuais.map((foto, idx) => (
                  ...
                  >
                    {/* Ícone de comentário se tiver algum */}
                    {foto.comentarios && foto.comentarios.length > 0 && (
                      <div className="absolute top-2 left-2 z-10 bg-white rounded-full p-1 shadow-md">
                        <FaCommentDots />
                      </div>
                    )}
                    ...
                    <img
                      ...
                      onClick={() => {
                        ...
                        console.log("fotosVisuais", fotosVisuais);
                        console.log("foto.comentarios", foto.comentarios);
                        setComentariosSelecionados(foto.comentarios || []);
                      }}
                    />
                  </div>
                ))}
      ...
      {imagemSelecionada && (
        ...
        >
          <div className="relative inline-block">
            ...
            {comentariosSelecionados.length > 0 && (
              <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-[90%] max-h-[200px] overflow-y-auto bg-white bg-opacity-90 text-black p-4 rounded-lg shadow-lg z-50">
                <h3 className="font-semibold mb-2">Comentários</h3>
                <ul className="space-y-2 text-sm">
                  {comentariosSelecionados.map((comentario, idx) => (
