...
<table>
  <tr>
    <th colspan="6" width="1000">CT-18<br>Permitir feedback dos trabalhos realizados</th>
  </tr>
  <tr>
    <td width="170"><strong>Critérios de êxito</strong></td>
    <td colspan="5">O sistema deve permitir que usuários façam feedback do trabalho da fotógrafa</td>
  </tr>
    <tr>
    <td><strong>Responsável pelo Teste</strong></td>
    <td width="430"> Bárbara Fernandes Sena </td>
  ...
  <tr>
      <td colspan="6" align="center"><video src="https://github.com/user-attachments/assets/5df92280-a21e-43d7-b439-f9f29205dd78"></td>
  </tr>
</table>
...
<table>
  <tr>
    <th colspan="6" width="1000">CT-019 <br>Teste para feedback do trabalho da fotógrafa</th>
  </tr>
  <tr>
    <td width="170"><strong>Critérios de êxito</strong></td>
    <td colspan="5">O sistema deve permitir que usuários realizem feedback</td>
  </tr>
  <tr>
    <td><strong>Responsável pela funcionalidade</strong></td>
    <td>Bárbara Fernandes Sena</td>
  ...
  <tr>
    <td><strong>Comentário</strong></td>
    <td colspan="5">Este caso de teste deve permitir que usuários realizem feedback</td>
  </tr>
  <tr>
    <td colspan="6" align="center"><strong>Evidência</strong></td>
  </tr>
